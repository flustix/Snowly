...
public class AboutSlashCommand extends SlashCommand {
    ...
    public void execute(SlashCommandInteraction interaction) {
        EmbedBuilder embed = new EmbedBuilder()
                ...
                .setThumbnail(Main.getShards().get(0).getSelfUser().getAvatarUrl())
                .setColor(Main.accentColor)
                .addField(":1234: Version", Main.getVersion(), true)
                ...
                .addField(":link: Invite Link", "[Click here](https://discord.com/api/oauth2/authorize?client_id=" + Main.getShards().get(0).getSelfUser().getId() + "&permissions=8&scope=bot%20applications.commands)", true)
